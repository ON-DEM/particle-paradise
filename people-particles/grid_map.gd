...
@onready var hourglassExhibit = preload("res://hourglass_exhibit.tscn")
@onready var gameExhibit = preload("res://game_exhibit.tscn")
@onready var liquefactionExhibit = preload("res://liquefaction_exhibit.tscn")
