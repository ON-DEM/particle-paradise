...
const AVALANCHE_INITIAL_PARTICLES = "res://data/avalanche/avalancheInitialParticles.bin"

const BASELINE_G0 = "res://data/avalanche/BaseLine_g0.bin"
const BASELINE_G30 = "res://data/avalanche/BaseLine_g30.bin"

const CYLINDER_G0_DZ05 = "res://data/avalanche/Cylinder_g0_dz0.5.bin"
const CYLINDER_G0_DZ10 = "res://data/avalanche/Cylinder_g0_dz1.0.bin"
const CYLINDER_G0_DZ15 = "res://data/avalanche/Cylinder_g0_dz1.5.bin"

const CYLINDER_G30_DZ05 = "res://data/avalanche/Cylinder_g30_dz0.5.bin"
const CYLINDER_G30_DZ10 = "res://data/avalanche/Cylinder_g30_dz1.0.bin"
const CYLINDER_G30_DZ15 = "res://data/avalanche/Cylinder_g30_dz1.5.bin"

const TET_G0_DZ05 = "res://data/avalanche/Tet_g0_dz0.5.bin"
const TET_G0_DZ10 = "res://data/avalanche/Tet_g0_dz1.0.bin"
const TET_G0_DZ15 = "res://data/avalanche/Tet_g0_dz1.5.bin"

const TET_G30_DZ05 = "res://data/avalanche/Tet_g30_dz0.5.bin"
const TET_G30_DZ10 = "res://data/avalanche/Tet_g30_dz1.0.bin"
const TET_G30_DZ15 = "res://data/avalanche/Tet_g30_dz1.5.bin"

const WALL_G0_A0_DZ05 = "res://data/avalanche/Wall_g0_a0_dz0.5.bin"
const WALL_G0_A0_DZ10 = "res://data/avalanche/Wall_g0_a0_dz1.0.bin"
const WALL_G0_A0_DZ15 = "res://data/avalanche/Wall_g0_a0_dz1.5.bin"

const WALL_G0_A45_DZ05 = "res://data/avalanche/Wall_g0_a45_dz0.5.bin"
const WALL_G0_A45_DZ10 = "res://data/avalanche/Wall_g0_a45_dz1.0.bin"
const WALL_G0_A45_DZ15 = "res://data/avalanche/Wall_g0_a45_dz1.5.bin"

const WALL_G30_A0_DZ05 = "res://data/avalanche/Wall_g30_a0_dz0.5.bin"
const WALL_G30_A0_DZ10 = "res://data/avalanche/Wall_g30_a0_dz1.0.bin"
const WALL_G30_A0_DZ15 = "res://data/avalanche/Wall_g30_a0_dz1.5.bin"

const WALL_G30_A45_DZ05 = "res://data/avalanche/Wall_g30_a45_dz0.5.bin"
const WALL_G30_A45_DZ10 = "res://data/avalanche/Wall_g30_a45_dz1.0.bin"
const WALL_G30_A45_DZ15 = "res://data/avalanche/Wall_g30_a45_dz1.5.bin"
...
func load_binary(path: String):
	...
	var particle_count = file.get_32()
...
# QUEUE PARTICLES (NEW)
# ----------------------------
func queue_particles(frame_data: Dictionary):

	for pid in frame_data.keys():

		if particle_nodes.has(pid):
			continue

		if not spawn_queue.has(pid):
			spawn_queue.append(pid)
...
func _process(delta):
	...
	# NEW: instead of spawning instantly
	queue_particles(frame_a)
	process_spawn_queue(frame_a)
	...
	match level:
		...
		2:
			if cur_sim == "CYLINDER_G0_DZ15":
				$CanvasLayer/Correct.visible = true
		3:
			if cur_sim == "CYLINDER_G30_DZ05":
				$CanvasLayer/Correct.visible = true
		4:
			if cur_sim == "CYLINDER_G30_DZ10":
				$CanvasLayer/Correct.visible = true
		5:
			if cur_sim == "CYLINDER_G30_DZ15":
...
func update_interpolated(alpha: float):
	...
	# FINAL FRAME: stop interpolation completely
	if current_frame >= frames.size() - 1:
		...
		for pid in active_pids:
			...
			if not final_frame.has(pid):
				continue

			var node = particle_nodes[pid]
	...
	for pid in active_pids:
		...
		var has_a = frame_a.has(pid)
		var has_b = frame_b.has(pid)
		...
		if has_a and has_b:
			...
			node.global_position = a["pos"].lerp(b["pos"], alpha)

			var s = lerp(a["size"], b["size"], alpha)
			node.scale = Vector3.ONE * s
			node.visible = true
...
func reset_simulation():
	...
	if not frames.is_empty():
		queue_particles(frames[0])
		process_spawn_queue(frames[0])
